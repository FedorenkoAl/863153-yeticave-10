                ...
                <section class="lot-item container">
                    ...
                    <div class="lot-item__content">
                        <div class="lot-item__left">
                            ...
                            <p class="lot-item__category">Категория: <span><?=$lots_id['c'];?></span></p>
                            <p class="lot-item__description"><?=$lots_id['description'];?></p>
                        </div>
                            ...
                            <div class="lot-item__state">
                                ...
                                <div class="lot-item__cost-state">
                                    <div class="lot-item__rate">
                                        ...
                                        <span class="lot-item__cost"><?=money($lots_id['price']);?></span>
                                    </div>
                                ...
                                <form class="lot-item__form" action="/lot.php?id=<?=$_GET['id'];?>" method="post" autocomplete="off">
                                    <p class="lot-item__form-item <?=$errors['cost'];?>">
                                        ...
                                        <input id="cost" type="text" name="cost" value="<?=$_POST['cost']; ?>" placeholder="<?=money_step($lots_id['min']);?>">
                            ...
                            <div class="history">
                                ...
                                <table class="history__list">
                                    ...
                                    <tr class="history__item">
                                        <td class="history__name"><?=$valu['name'];?></td>
                                        <td class="history__price"><?=money($valu['price']);?>
                                            </td>
